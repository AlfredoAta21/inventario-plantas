...
CREATE TABLE `planta` (
  ...
  `Propiedades` varchar(255) DEFAULT NULL,
...
INSERT INTO `planta` VALUES ('Girasol','Muy Amarilla','yirasol','bonita','ninguno'),('Menta','verde aromatica','Mentus','Aromatica','ningunp'),('Rosa','roja','rose','huele maso','bien');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `obtener_admin` */;
...
DELIMITER ;;
CREATE DEFINER=`Hiram`@`localhost` PROCEDURE `obtener_admin`(Nombre_User varchar(20), Contraseña_user varchar(255))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`Hiram`@`localhost` PROCEDURE `validacion_usuario`(Nombre_User varchar(20), Contraseña_user varchar(255))
BEGIN
		SELECT * 
        FROM Usuario 
        WHERE Nombre = Nombre_User
...
-- Dump completed on 2025-02-20 18:32:23
