...
DELIMITER ;;
CREATE DEFINER=`Hiram`@`localhost` PROCEDURE `validacion_usuario`(Nombre_User varchar(20), Contraseña_user varchar(255), Adminis_user BOOLEAN)
BEGIN
		SELECT * 
        FROM Usuario 
...
-- Dump completed on 2025-02-13 19:58:47
